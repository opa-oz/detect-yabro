...
export {
    isIOSYabro, isMacOSYabro, isWindowsYabro, isMobileYabro, Platforms, isYabro, isAndroidYabro, isLinuxYabro
} from '@detect-yabro/common';

const detectYabro = () => (req: Request, res: Response, next: () => void) => {
